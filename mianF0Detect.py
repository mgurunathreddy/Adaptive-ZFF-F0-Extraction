...
Description: Finds the F0 contour of the given speech signal by 1. Indentifying speech activity regions followed by 
             identifing resonant frequency from SSh, then filtering each voice activity region with approx. resonant frequency
Inputs: This is the main program
Outputs: F0 contour
